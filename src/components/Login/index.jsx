...
const Login = () => {
  ...
  return (
    <div className="flex flex-col  border-solid border-gray-300 border-2 p-4 rounded-3xl w-[586px] h-[525px] mx-[480px] my-6">
      ...
      <h2 className=" text-xl font-bold mx-[125px] my-1">
        Welcome back to ECOMMERCE
      </h2>
      <p className="text-sm font-medium px-36">
      ...
      <form onSubmit={handleSubmit}>
        <div className="px-20 py-3">
          ...
          <input
            ...
            className="flex flex-col border-gray-300 border-2 rounded-md w-[356px] h-[36px] my-1 p-4"
            required
          />
        </div>
        <div className="px-20 py-3">
        ...
        <button
          type="submit"
          className=" bg-black text-white w-[356px] h-[36px] rounded-md text-sm px-3 mx-20 my-4"
        >
          LOGIN
        </button>
      </form>
      <p className="px-40 py-4">
